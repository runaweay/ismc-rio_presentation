...
- Rio-pav (paved soils) - Bellas Artes, Santiago, Chile - 3 sites;
- Rio-ug (urban green space soils) - Cerro Santa Lucía and Parque Forestal, Santiago, Chile - 2 sites.

**Analyses**

- Soil samples: air-dried, sieved (\< 2 mm), analyzed in triplicate;
- Texture: determined after OM removal (H2O2, 30%), PARIO sensor;
- pH: measured at 1:2.5 ratio;
- Total C: high-temperature catalytic combustion (TOC-L, Shimadzu, Japan).
:::

::: methods-image-area
<img src="plots/latin_america.png" alt="Sampling points map"/>
:::
:::::
...
![](plots/dotplot_mean_se.png){fig-align="center" width="900"}
</div>

## Results - Chilean soils background

<div style="margin-top: 100px;">
![](plots/steinfort.png){fig-align="center" width="900"}
</div>
...
::: {style="font-size:0.55em; text-align:left;"}
...
## Thank you! {data-background-color="#FFF5EE"}

**Mariana Dos Santos Moreno**

*mdsmoreno\@estudiante.uc.cl*

- All code, results, and maps for this work are available on GitHub: **[github.com/runaweay/ismc-rio_presentation](https://github.com/runaweay/ismc-rio_presentation)** - The project is built with Quarto and R, and should run in any environment with R and the required packages installed (RStudio, VS Code, Positron, etc).
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (titleSlide) {
    ...
    logos.innerHTML =
      ...
      '<span class="funding-text">Project funded by FONDECYT, 11260726FINI</span>';
